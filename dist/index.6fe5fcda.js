...
// setup
const ECS = new (0, _indexDefault.default)();
...
const growProcesssor = {
    ...
    update (component, entities) {
        entities.forEach((entity)=>{
            ...
            if (entity.state.width > entity.state.maxGrowSize) ECS.removeEntity(entity);
        });
    }
};
...
class EntityComponentSystem {
    ...
    addComponentToEntity(entity, component) {
        ...
        if (!hasComponent) throw new Error(`addComponentToEntity(): You can't add component ${component.name} to entity ${entity.name}, because the component is not registered.`);
...
exports.default = EntityComponentSystem;
